...
?>
			...
			<div class="wrapper">
				...
				<?php
					...
					while($chore = $query->fetch(PDO::FETCH_ASSOC)){
						echo "
					<tr>
						<td class=\"choretdlable\">". $chore['choreName'] . "</td>
						<td class=\"choretdlable\">" . $chore['choreValue'] . "</td>
						<td><a href=\"editChore.php?choreID=" . $chore['choreID'] . "&amp;groupID=$groupID\"><button type=\"button\" class=\"tableButton\">Edit</button></a></td>
					</tr>";
					}
				}
			...
			<div class="wrapper">
				...
				echo "
					<tr><th>First Name</th><th>Last Name</th><th>Score</th><th>View</th></tr>";
				foreach ($dbcon->query($query) as $result){
					...
					<tr>
						...
						<td><a href=\"profile.php?userID=" . $result['userID'] . "&amp;groupID=$groupID\"><button type=\"button\" class=\"tableButton\">View Profile</button></a></td>
					</tr>";
				}
				?>
